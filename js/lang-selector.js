...
(function() {
  ...
  var currentHash = window.location.hash || ''; // Preserve product ID
  var currentSearch = window.location.search || ''; // Preserve query params
  ...
  var enLink = (isEnglish ? currentPage : '/en/' + currentPage) + currentSearch + currentHash;
  var esLink = (isEnglish ? '/' + currentPage : currentPage) + currentSearch + currentHash;
